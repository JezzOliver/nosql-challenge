...
2 jupyter files
NoSQL_analysis_starter-JeremyFinal
NoSQL_setup_starter-JeremyFinal

Did get some help from 1 colleague from proj 2 team 6 who suggested to use $convert to change RatingValue to integer to account for nulls

Descrition of Challenge
